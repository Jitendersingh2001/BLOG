            ...
            <form id="Admin-profile-form">
                ...
                <!-- <div class="Admin-password hide ">
                    <div class="mb-6">
                        ...
                        <input type="Password" id="user-password" class="bg-gray-50 border admin-Password border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600  dark:text-white dark:focus:ring-blue-500 cursor-not-allowed dark:focus:border-blue-500" placeholder="Type Your Current Password" value="{{ Auth::user()->password}}">
                    </div>
                </div> -->
