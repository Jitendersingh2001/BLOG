...
<body>
    ...
    <!-- PROFILE START -->
    <div class="p-4 sm:ml-64 mt-14 profile-container">
            ...
            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-gray-400 md:ml-2 cursor-pointer dark:text-gray-500" aria-current="page">Profile</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="profile-heading">
            <h1 class="text-3xl font-bold dark:text-white">User Profile</h1>
        </div>
